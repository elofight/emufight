> **Elofight fork** of [aaronsgiles/ymfm](https://github.com/aaronsgiles/ymfm). Extra commit: YM2610 serialization for deterministic rollback ([emufight](https://github.com/elofight/emufight)).
